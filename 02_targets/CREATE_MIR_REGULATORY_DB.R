...
ref_path <- paste0(ANNOT_DIR, "/ANNOTATIONS/")
...
genome_feat <- read_rds(paste0(ANNOT_DIR, "/genome_features.rds"))[[1]]
...
write_tsv(DB, paste0(paste0(ANNOT_DIR, "/"), "GENOME_FEATURES_UNIPROT.tsv"))
