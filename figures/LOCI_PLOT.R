...
ggplot2::ggsave(p1, filename = "LOCI_PROPORTION.png", path = RESULTS_DIR, width = 2.5, height = 1.5, device = png, dpi = 300)
...
p2
# ggsave(p2, filename = 'Nearest_distance.png', path = RESULTS_DIR, width = 3.5, height = 2.5, device = png, dpi = 500)
...
ggsave(p, filename = 'LOCI_PLOT2.png', path = RESULTS_DIR, width = 2.7, height = 7, device = png, dpi = 500)

# ggplot2::ggsave(p, filename = "SRNA_LOCATION_MIRS_ES.png", path = RESULTS_DIR, width = 7, height = 5, device = png, dpi = 300)
