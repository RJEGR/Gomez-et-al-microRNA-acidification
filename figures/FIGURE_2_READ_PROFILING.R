...
MTD <- read_tsv(file.path(DATA_DIR, "METADATA.tsv"))
...
ggsave(ps, filename = 'FIGURE_2.png', path = RESULTS_DIR, width = 2, height = 1.7, device = png, dpi = 300)
...
ggsave(ps, filename = 'PROFILING_SAMPLES_BY_READ.png', path = RESULTS_DIR, width = 6, height = 5.5, device = png)
...
ggsave(ps, filename = 'PROFILING_SAMPLES_BY_READ_LENGTH_NUC.png', path = RESULTS_DIR, width = 4.5, height = 5, device = png, dpi = 300)
...
ggsave(ps, filename = 'PROFILING_SAMPLES_BY_READ_LENGTH_NUC_kmiRNAs.png', path = RESULTS_DIR, width = 2.5, height = 3.5, device = png)
...
ggsave(ps, filename = 'PROFILING_SAMPLES_BY_READ_2.png', path = RESULTS_DIR, width = 4, height = 4.5, device = png, dpi = 300)

# PLOT CLADE SPECIFIC MIRS? ====

path <- paste0(ANNOT_DIR, "/")
...
ggsave(ps, filename = 'CLADE_SPECIFIC_MIR.png', path = RESULTS_DIR, width = 7.2, height = 4, device = png)
