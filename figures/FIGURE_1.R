...
ggsave(bottom, filename = 'FIGURE_1_PANEL_A.png', path = RESULTS_DIR, 
...
ggsave(pss, filename = 'FIGURE_1_PANEL_B.png', path = RESULTS_DIR, 
...
ggsave(f1, filename = 'FIGURE_1.png', path = RESULTS_DIR, 
